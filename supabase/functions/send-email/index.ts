    ...
    <tr>
      <td style="background:#fff;padding:32px;border:1px solid #e8e4df;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:${BG};padding:16px;">
          ...
          <tr>
            <td style="font-size:13px;color:${GREEN};">19, Luj Paster str, Skopje 1000</td>
          </tr>
        </table>` : ''}
...
async function sendEmail(to: string, subject: string, html: string): Promise<void> {
  ...
  const from    = Deno.env.get('RESEND_FROM') ?? 'Zielinski & Rozen <Skopje@springsioux.com>'
